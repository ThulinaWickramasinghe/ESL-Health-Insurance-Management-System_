...
$sqlstmt = "SELECT userName FROM Basic_D";
$result = array();
if ($queryReult = mysqli_query($conn, $sqlstmt)) {
    while ($row = $queryReult->fetch_assoc()) {
...
<body>
    ...
    <div style="font-weight: bold; margin-top: 20px;">
        ...
        <br>
        <form action="./php/U_signup.php" method="post">
            <fieldset class="mainFieldset">
                ...
                <br>
                <!--had  to  remove patterns to check dummy values-->
                <!--pattern="/(^[0-9]{9}[V,X]$)|(^[0-9]{12}$)/i -->
                <input type="text" name="NIC" id="NIC" maxlength="12" required>
                <p id="rqrd">*Required</p>
                <br>
                <br>
                ...
                <br>
                <!-- pattern="/^[0-9]{3}-[0-9]{7}$/" "-->
                <input type="tel" name="pTpNo" id="pTpNo" maxlength="11" placeholder="012-3456789">
            ...
            <fieldset class="mainFieldset">
                <br>
                <legend>Details of Bank Account</legend>
            ...
            <fieldset class="mainFieldset" id="insAccDetails">
                ...
                <input type="text" name="userName" id="userName" placeholder="Username" onkeyup="validateUser()"><br><br><br>
            ...
            <div id="termsDiv">
                <input type="checkbox" name="terms" id="terms" onclick="termsChecking()">
            ...
            <input type="submit" name="formSubmit" value="Submit" id="formSubmit" disabled="true" onmouseover="cursorChange()">
        </form>
    </div>
    ...
    <script>
        var userNames = <?php echo json_encode($result); ?>
        ...
        function validateUser() {
            ...
            for (let i = 0; i < userNames.length; i++) {
                ...
                if (userNames[i] === userName) {
                    ...
                    invalid = true;
                    document.getElementById('invUsername').style.color = 'red';
                    document.getElementById('invUsername').innerHTML = 'Sorry, this username is already in use.';
                } else {
                    console.log(userName)
                    if (!invalid) {
                        document.getElementById('invUsername').style.color = 'green';
                        document.getElementById('invUsername').innerHTML = 'Valid User Name';
                    }
                }
            }
        }
        ...
        //enable submit buttom
        // var submitBtn = document.getElementById('formSubmit');
        // var formSubmitcheckbox = document.getElementById('terms');
        ...
        function cursorChange() {
            var sbmtbutton = document.getElementById('formSubmit');
            if (sbmtbutton.disabled == true) {
                sbmtbutton.style.cursor = "none";
            } else {
                sbmtbutton.style.cursor = "pointer";
            }
        }
    </script>
</body>
